...
class Phase1SyncPayloadMapper {
  ...
  Map<String, Object?> transactionPayload(db.Transaction row) {
    return _validatedPayload(
      ...
      payload: <String, Object?>{
        ...
        'discount_value_minor': row.discountValueMinor,
        'discount_amount_minor': row.discountAmountMinor,
        'discount_reason': row.discountReason,
        'discount_applied_by_local_id': row.discountAppliedBy,
  ...
  Map<String, Object?> _validatedPayload({
