...
void main() {
  ...
  testWidgets(
    'final close dialog requires counted cash before submit',
    (WidgetTester tester) async {
      ...
      await tester.tap(find.widgetWithText(ElevatedButton, AppStrings.adminFinalClose));
      await tester.pumpAndSettle();
  ...
  testWidgets(
    'final close dialog returns entered counted cash',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'final close dialog rejects negative counted cash',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        _testApp(
          child: Builder(
